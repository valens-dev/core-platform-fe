...
import Template9 from '@assets/images/template-9.png';
import Template10 from '@assets/images/template-10.png';
...
export const templateChips = [
  ...
  { label: 'AWS', color: '#FA8C16', background: '#FFD591' },
  { label: 'Azure', color: '#2F54EB', background: '#ADC6FF' },
  { label: 'IBM', color: '#52C41A', background: '#B7EB8F' },
];
...
export const navData = [
  ...
  {
    icon: SettingsIcon,
    navTitle: 'one group of templates',
    hasArrow: true,
  },
  {
    icon: SettingsIcon,
    navTitle: 'Second group of templates',
    hasArrow: true,
  },
  {
    icon: SettingsIcon,
    navTitle: 'Navigation Four',
    hasArrow: false,
  },
  {
    icon: SettingsIcon,
    navTitle: 'Navigation Five',
    hasArrow: false,
  },
];
